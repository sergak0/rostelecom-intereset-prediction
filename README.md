...
## Проверка метрики на сабмите
Данные по предсказаниям лежат в @sergak_blog.csv. **Нумерация в этих данных id идет с 1** - как было сказано в гайде (Если id==1, то он соотвествует нулевой стоке в изначальных данных)
## Запуск решения
